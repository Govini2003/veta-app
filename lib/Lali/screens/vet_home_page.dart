    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(Icons.person, color: Colors.black), // Adding person icon
            onPressed: () {
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.business), label: 'Insights'), // Changed from 'Services' to 'Insights'
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: TextButton(
                onPressed: () {},
                child: Text(actionText, style: const TextStyle(color: Color(0xFF357376))),
              ),
            ),
          ],
        ),
