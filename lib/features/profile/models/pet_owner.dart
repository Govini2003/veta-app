// veta-app/lib/features/profile/models/pet_owner.dart
...
class PetOwner {
  ...
  final List<String> friendIds; // List of friend email ID
  final List<String> pendingFriendRequests; // List of pending friend request email ID
  final List<String> sentFriendRequests; // List of sent friend request email ID
