//veta-app/frontend1/lib/Lali/screens/vet_payments_page.dart
...
class _VetPaymentPageState extends State<VetPaymentPage> {
  ...
  Future<void> _processPayment(int index) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Payment ${payments[index]['id']} processed successfully'),
          ...
          RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final formattedDate = DateFormat('MMM dd, yyyy').format(payment['date']);
                final formattedAmount = NumberFormat.currency(symbol: '\$').format(payment['amount']);
