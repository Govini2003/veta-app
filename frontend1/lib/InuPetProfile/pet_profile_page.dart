...
class PetProfilePage extends StatefulWidget {
  ...
  final Function()? onDelete; // Add delete callback
  final Function(File?, double?)? onSave; // Add onSave callback
  ...
  const PetProfilePage({
    ...
    this.onSave, // Add to constructor
  }) : super(key: key);
...
class _PetProfilePageState extends State<PetProfilePage> {
  ...
  double? _currentWeight; // Add weight controller
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to delete ${widget.petName}\'s profile? This action cannot be undone.'),
          actions: [
            TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _hasChanges ? Container(
              ...
              Row(
                children: [
                  SizedBox(
                    width: 50,
                    child: TextFormField(
                      initialValue: widget.weight?.toString() ?? "0",
